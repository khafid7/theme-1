...
class InvitationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Invitation::create([
            ...
            'akad_datetime' => Carbon::parse('2026-04-20 08:00:00'), // Format: YYYY-MM-DD HH:MM:SS
        ...
        Invitation::create([
            ...
            // 4. ACARA 1 (AKAD)
            'akad_title' => 'Akad Nikah',
            'akad_datetime' => Carbon::parse('2026-05-20 08:00:00'), // Format: YYYY-MM-DD HH:MM:SS
            'akad_location' => 'Masjid Al-Ikhlas',
            'akad_address' => 'Jl. Merpati No. 10, Jakarta Selatan',
            'akad_map_link' => 'https://goo.gl/maps/contoh1',
        ...
        Invitation::create([
            // 1. CONFIG
            'slug' => 'budi-bunga', // Ini nanti jadi link: domain.com/romeo-juliet
            'theme' => 'floral-pastel',
            'is_active' => true,
            ...
            'groom_father' => 'Bpk. Adam',
            'groom_mother' => 'Ibu Hawa',
            'groom_instagram' => 'budi_setiawan',
            'groom_photo' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1000',

            // 3. MEMPELAI WANITA
            'bride_name' => 'Bunga Larisa',
            'bride_nickname' => 'Bunga',
            'bride_father' => 'Bpk. Capulet',
            'bride_mother' => 'Ibu Lady',
            'bride_instagram' => 'bunga_larisa',
            'bride_photo' => 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1000',

            // 4. ACARA 1 (AKAD)
            'akad_title' => 'Akad Nikah',
            'akad_datetime' => Carbon::parse('2026-06-20 08:00:00'), // Format: YYYY-MM-DD HH:MM:SS
            'akad_location' => 'Masjid Al-Ikhlas',
            'akad_address' => 'Jl. Merpati No. 10, Jakarta Selatan',
            'akad_map_link' => 'https://goo.gl/maps/contoh1',
        ...
        Invitation::create([
            // 1. CONFIG
            'slug' => 'gunawan-nabila', // Ini nanti jadi link: domain.com/romeo-juliet
            'theme' => 'watercolor-flow',
            'is_active' => true,

            // 2. MEMPELAI PRIA
            'groom_name' => 'Gunawan Setyo',
            'groom_nickname' => 'Gunawan',
            'groom_father' => 'Bpk. Adam',
            'groom_mother' => 'Ibu Hawa',
            'groom_instagram' => 'budi_setiawan',
            'groom_photo' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1000',
            ...
            // 4. ACARA 1 (AKAD)
            'akad_title' => 'Akad Nikah',
            'akad_datetime' => Carbon::parse('2026-07-20 08:00:00'), // Format: YYYY-MM-DD HH:MM:SS
            'akad_location' => 'Masjid Al-Ikhlas',
            'akad_address' => 'Jl. Merpati No. 10, Jakarta Selatan',
            'akad_map_link' => 'https://goo.gl/maps/contoh1',
        ...
        Invitation::create([
            // 1. CONFIG
            'slug' => 'setyo-manda', // Ini nanti jadi link: domain.com/romeo-juliet
            'theme' => 'ocean-breeze',
            'is_active' => true,

            // 2. MEMPELAI PRIA
            'groom_name' => 'Setyo Ramadhan',
            'groom_nickname' => 'Setyo',
            'groom_father' => 'Bpk. Adam',
            'groom_mother' => 'Ibu Hawa',
            'groom_instagram' => 'budi_setiawan',
            'groom_photo' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1000',
            ...
            // 3. MEMPELAI WANITA
            'bride_name' => 'Manda Fransiska',
            'bride_nickname' => 'Manda',
            'bride_father' => 'Bpk. Capulet',
            'bride_mother' => 'Ibu Lady',
            'bride_instagram' => 'bunga_larisa',
            'bride_photo' => 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1000',
            ...
            // 4. ACARA 1 (AKAD)
            'akad_title' => 'Akad Nikah',
            'akad_datetime' => Carbon::parse('2026-08-20 08:00:00'), // Format: YYYY-MM-DD HH:MM:SS
            'akad_location' => 'Masjid Al-Ikhlas',
            'akad_address' => 'Jl. Merpati No. 10, Jakarta Selatan',
            'akad_map_link' => 'https://goo.gl/maps/contoh1',
        ...
        Invitation::create([
            // 1. CONFIG
            'slug' => 'shaka-nory', // Ini nanti jadi link: domain.com/romeo-juliet
            'theme' => 'boho-terracotta',
            'is_active' => true,

            // 2. MEMPELAI PRIA
            'groom_name' => 'Shaka Antares',
            'groom_nickname' => 'Shaka',
            'groom_father' => 'Bpk. Adam',
            'groom_mother' => 'Ibu Hawa',
            'groom_instagram' => 'budi_setiawan',
            'groom_photo' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1000',
            ...
            // 4. ACARA 1 (AKAD)
            'akad_title' => 'Akad Nikah',
            'akad_datetime' => Carbon::parse('2026-09-29 08:00:00'), // Format: YYYY-MM-DD HH:MM:SS
            'akad_location' => 'Masjid Al-Ikhlas',
            'akad_address' => 'Jl. Merpati No. 10, Jakarta Selatan',
            'akad_map_link' => 'https://goo.gl/maps/contoh1',
            ...
            // 5. ACARA 2 (RESEPSI)
            'resepsi_title' => 'Resepsi Pernikahan',
            'resepsi_datetime' => Carbon::parse('2026-02-29 11:00:00'),
            'resepsi_location' => 'Grand Ballroom Hotel',
            'resepsi_address' => 'Jl. Sudirman Kav. 50, Jakarta Pusat',
            'resepsi_map_link' => 'https://goo.gl/maps/contoh2',

            // 6. GIFT (Rekening Bank)
            'bank_name' => 'BCA',
            'bank_number' => '123 456 7890',
            'bank_holder' => 'Setyo Ramadhan',
        ...
        Invitation::create([
            // 1. CONFIG
            'slug' => 'andreas-putri', // Ini nanti jadi link: domain.com/romeo-juliet
            'theme' => 'emerald-garden',
            'is_active' => true,

            // 2. MEMPELAI PRIA
            'groom_name' => 'Andreas Lauren',
            'groom_nickname' => 'Andreas',
            'groom_father' => 'Bpk. Adam',
            'groom_mother' => 'Ibu Hawa',
            'groom_instagram' => 'budi_setiawan',
            'groom_photo' => 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1000',
